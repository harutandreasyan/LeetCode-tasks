...
let root1 = buildTreeFromArray([5, 8, 9, 2, 1, 3, 7, 4, 6])
console.log(kthLargestLevelSum(root1, 2)) // 13

let root2 = buildTreeFromArray([1, 2, null, 3])
console.log(kthLargestLevelSum(root2, 1)) // 3

let root3 = buildTreeFromArray([1, -5, 4, 3, 4, 5, null, 7])
console.log(kthLargestLevelSum(root3)) // -1
